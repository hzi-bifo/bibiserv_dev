...
import de.unibi.techfak.bibiserv.web.beans.session.AbstractServerAndCloudInputBean;
 ...
 */
public class <#getClassName/#>  extends AbstractServerAndCloudInputBean {
    ...
    public boolean supportsStreamedInput() {
        return <#getStreamSupport/#>;
    }
    
     /**
     * TODO: TG 05/13 Change this if want to enable access to files on server as input
     * @return true: file access is disabled; false: user can define input as file URI on server
     */
    public boolean isServerFileDisabled() {
        return true;
    }
}
