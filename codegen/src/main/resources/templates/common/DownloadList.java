    ...
    */
    ...
    private DownloadItem[] generateDownloadItems(){
        ...
        for (int i = 0; i < list_of_downloadable.size(); ++i){
            ...
            String uri = downloadable.isSetFilename()?"/applications/"+tooldescription.getToolDescription().getId()+"/resources/downloads/"+downloadable.getFilename():downloadable.getUrl();
