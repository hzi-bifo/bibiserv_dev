...
/**
 * Class CodeGen_WebSubmissionPage_Formatchooser extends CodeGen_WebSubmissionPage_Function,
 * generates for each input a choosing field which representation is wanted.
 *
 *
 * @author Jan Krueger - jkrueger(at)cebitec.uni-bielefeld.de
 */
public class CodeGen_WebSubmissionPage_Formatchooser extends CodeGen_WebSubmissionPage_Function{

    public CodeGen_WebSubmissionPage_Formatchooser(){
        super();
        setExtensionName("_p_1b");
    }
    ...
    public InputStream getDefaultTemplate() {
        return CodeGen_Implementation.class.getResourceAsStream("/templates/page_submission_formatchooser.xhtml");
    }
