 ...
 */
public class CodeGen_WebSubmissionPage_Result extends CodeGen_WebSubmissionPage_Function {

    public CodeGen_WebSubmissionPage_Result(){
        super();
        setExtensionName("_result");
    }

      @Override
    public InputStream getDefaultTemplate() {
        return CodeGen_Implementation.class.getResourceAsStream("/templates/page_submission_result.xhtml");
    }
